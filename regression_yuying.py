# -*- coding: utf-8 -*-
"""
Created on Sun Dec 13 21:55:13 2020
...
# Yuying's
t1_features = pd.read_csv('features/yuying_features/t1_radio_features.csv', header=None)
t1Gd_features = pd.read_csv('features/yuying_features/t1Gd_radio_features.csv', header=None)
t2_features = pd.read_csv('features/yuying_features/t2_radio_features.csv', header=None)
flair_features = pd.read_csv('features/yuying_features/flair_radio_features.csv', header=None)
...
# my_cph.fit(all_features_reduced.drop(['original_shape_Flatness_1'],axis=1), duration_col = 'days_to_death', event_col='vital_status')
